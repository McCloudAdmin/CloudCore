...
public class BungeeWebSocketClient {
    ...
    public BungeeWebSocketClient(CloudCoreBungee plugin, ProxyServer server) {
        this.plugin = plugin;
        this.server = server;
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) {
                        ...
                        p.addLast(
                            ...
                            new BungeeWebSocketHandler(handshaker, BungeeWebSocketClient.this)
                        );
                    }
                });
    ...
    public CloudCoreBungee getPlugin() {
        return plugin;
    }
} 