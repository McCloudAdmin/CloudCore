...
public class WorkerManager {
    ...
    public WorkerManager(CloudCoreConfig config, DatabaseManager databaseManager, Logger platformLogger) {
        this.config = config;
    ...
    public void initialize() {
        if (validateWorkerCredentials()) {
            if (!workerExists()) {
                ...
                cloudLogger.info("Worker already registered in database");
            }
