...
public class ChatlogCommand implements SimpleCommand {
    ...
    public void execute(Invocation invocation) {
        ...
        Component message = Component.text(messageManager.getColoredMessage(Messages.CHATLOG_LINK))
            .append(Component.text(chatlogUrl)
                .clickEvent(ClickEvent.openUrl(chatlogUrl))
                .hoverEvent(HoverEvent.showText(Component.text("Click to view chat log", TextColor.color(0x808080)))));
